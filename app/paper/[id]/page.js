...
export default function Home() {
  ...
  const filteredPapers = papers.filter((paper) => {
    ...
    const matchesCategory =
      ...
      paper.examtype === selectedCategory;
  ...
  return (
    <main className="min-h-screen bg-[#020817] text-white">
      ...
      <nav className="sticky top-0 z-50 border-b border-white/10 bg-[#020817]/90 backdrop-blur-xl">
        ...
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex gap-3">
            ...
            <a
              href="/login"
              className="bg-white/5 border border-white/10 hover:bg-white/10 transition px-5 py-2 rounded-xl font-semibold"
            >
              Admin Login
            </a>
            ...
            >
              ...
              <div className="flex items-center justify-between mb-6">
                ...
                <span className="bg-blue-500/10 text-blue-400 border border-blue-500/20 px-4 py-2 rounded-full text-sm font-bold">
                  {paper.category || paper.examtype || "Paper"}
                </span>
              ...
              <p className="text-gray-400 mt-4 leading-relaxed text-sm min-h-[60px]">
                Download previous year papers, notes and important PDFs.
              </p>
      ...
      {/* FEATURES */}
      <section className="py-24 border-t border-white/10 bg-gradient-to-b from-[#020817] to-[#081226]">
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="text-5xl font-black">
              Why Students Love Paperlix
            </h2>

            <p className="text-gray-400 mt-6 text-xl max-w-3xl mx-auto">
              Modern study experience designed for students who want speed,
              simplicity and trusted study material.
            </p>
            ...
            {[
              {
                ...
                desc: "Find papers instantly with smart filters and search.",
              },
              {
                title: "Real PDF Downloads",
                desc: "Preview and download study material without ads.",
              },
              {
                title: "Mobile Friendly",
                desc: "Optimized for phones, tablets and laptops.",
              },
            ].map((item, i) => (
              <div
                key={i}
      ...
      <footer className="border-t border-white/10 py-14 bg-[#020817]">
        ...
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-gray-500 mt-2 text-sm">
            Founded by
            <span className="text-blue-400 font-semibold"> Arsh Grewal</span>
          </p>
